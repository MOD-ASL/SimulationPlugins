...
_CONFIGMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ModelPath', full_name='config_message.msgs.ConfigMessage.ModelPath', index=10,
...
_CONFIGMESSAGE.fields_by_name['ModelPosition'].has_options = True
_CONFIGMESSAGE.fields_by_name['ModelPosition']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\020\001')
_CONFIGMESSAGE.fields_by_name['JointAngles'].has_options = True
_CONFIGMESSAGE.fields_by_name['JointAngles']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\020\001')
